...
app = webapp2.WSGIApplication([
    ...
    ('/camp/create', camps.CreateCampTarget),
    ('/camp/get', camps.GetCampTarget),
    ('/camp/getAll', camps.GetAllCampTargets),
    ('/camp/update', camps.UpdateCampTarget),
    ('/camp/delete', camps.DeleteCampTarget),
    ...
    ('/campmemberitem/delete', camps.DeleteCampTargetMemberItem),
    ('/', MainPage),
], debug=True)
